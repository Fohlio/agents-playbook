...
export abstract class SubAgentBase implements SubAgent {
  ...
  constructor(type: AgentType, config: SubAgentConfig) {
  ...
  protected async loadMiniPrompt(context: IsolatedContext): Promise<string> {
    try {
  ...
  protected abstract getMiniPromptPath(): string;

  protected getDefaultMiniPrompt(): string {
    switch (this.type) {
...
`;
  ...
  protected preparePrompt(miniPrompt: string, context: IsolatedContext): string {
...
`;
  ...
  protected formatHandoffSummary(handoff: any): string {
    return `
...
`;
  ...
  protected async executeInCursor(prompt: string, context: IsolatedContext): Promise<any> {
  ...
  protected prepareTaskPrompt(prompt: string, context: IsolatedContext): string {
    return `${prompt}
...
Please complete this task step by step and provide clear outputs.`;
  ...
  protected async executeWithTaskTool(taskPrompt: string): Promise<any> {
  ...
  protected processTaskResult(result: any): any {
  ...
  async validateOutput(result: any): Promise<boolean> {
  ...
  protected abstract performSpecificValidation(result: any): Promise<boolean>;

  protected async prepareHandoff(result: any, context: IsolatedContext): Promise<any> {
  ...
  protected compressContext(result: any, context: IsolatedContext): string {
