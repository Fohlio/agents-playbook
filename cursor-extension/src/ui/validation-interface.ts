...
export class ValidationInterface {
  ...
  async showValidation(options: ValidationUIOptions): Promise<void> {
    ...
    if (this.currentPanel) {
      ...
      this.currentPanel.webview.onDidReceiveMessage(
        message => this.handleWebviewMessage(message, options)
      );
    }
  ...
  private async handleWebviewMessage(message: any, options: ValidationUIOptions): Promise<void> {
  ...
  private async handleApproval(options: ValidationUIOptions): Promise<void> {
    try {
  ...
  private async handleRejection(options: ValidationUIOptions, reason: string): Promise<void> {
    try {
      if (options.onReject) {
  ...
  private async handleModification(options: ValidationUIOptions, changes: any): Promise<void> {
    try {
      if (options.onModify) {
  ...
  private async handleSkip(options: ValidationUIOptions, reason: string): Promise<void> {
    try {
      if (options.onSkip) {
  ...
  private async refreshValidation(options: ValidationUIOptions): Promise<void> {
    if (this.currentPanel) {
      this.currentPanel.webview.html = this.getValidationHTML(options);
    }
  }

  private closeValidation(): void {
    if (this.currentPanel) {
  ...
  private getValidationHTML(options: ValidationUIOptions): string {
...
<body>
  ...
  private formatOutputValue(value: any): string {
