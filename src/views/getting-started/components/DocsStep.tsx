    ...
    mcp: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Go to Settings → API Tokens → Create New Token. Copy and add to MCP config as the "apiKey" field, which should be automatically converted to "Authorization: Bearer <token>" header. Alternatively, use the "headers" field with "Authorization: Bearer <token>" if the apiKey field doesn\'t work.'
        },
        {
          heading: 'Usage',
