            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
              {miniPrompts.map((miniPrompt) => (
                <SortableItem key={miniPrompt.id} id={miniPrompt.id}>
                  <MiniPromptDiscoveryCardWidget
                    miniPrompt={miniPrompt as unknown as import('@/views/discover/types').PublicMiniPromptWithMeta & { tags?: { tag: { id: string; name: string; color: string | null } }[] }}
                    onImport={() => {}}
