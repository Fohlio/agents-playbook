...
export async function POST(request: Request) {
  ...
  if (body.key) {
    // Manual key can only be set for system mini-prompts by admins
    ...
    // Auto-generate key for all mini-prompts
    key = generateUniqueKey(body.name || 'Untitled Mini-Prompt');
  }
