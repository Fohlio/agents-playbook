...
import aiAssistantBasePrompt from '@/server/prompts/ai-assistant-base.txt';
import aiAssistantWorkflowPrompt from '@/server/prompts/ai-assistant-workflow.txt';
import aiAssistantMiniPromptPrompt from '@/server/prompts/ai-assistant-mini-prompt.txt';
